    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-[36px] leading-[44px] text-[26px] leading-[36px] font-semibold text-gray-800">
          ...
          <p className="text-sm">Course by <span className="text-blue-600 underline">Soumya Hedaoo</span></p>

          <div className="pt-8 text-grey-800">
        ...
        <div className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t p-3 md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray=500">
              ...
              <div className="flex items-center gap-1">
                  ...
                  <p>{calCourseDuration(courseData)}</p>
              </div>
              ...
              <div className="flex items-center gap-1">
                  ...
                  <p>{calLecCount(courseData)} Lessons</p>
              </div>
          </div>
          <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
            {isEnrolled ? "Alread Enrolled" : "Enroll Now"}
          </button>
          <div className="pt-6">
            <p className="md:text-xl text-lg font-medium text-gray-800">Whats in this Course ?</p>
            <ul className="ml-4 pt-2 text-sm md:text-default list-diac text-gray-500">
              <li>Lifetime acess with free updates</li>
              <li>Step-bu-step , handson project guidence</li>
              <li> Downloadable recourse and source course</li>
              <li>Quizzes to test your Kowledge</li>
