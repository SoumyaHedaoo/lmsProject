...
const Player = () => {
  ...
  const {myCourses, calChapterTime} =useContext(AppContext);
  const {id} = useParams();
  ...
  useEffect(()=>{
    ...
    <>
      <div className="p-4 sm:p10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36">
        ...
        <div className="md:mt-10">{/*right col*/}
            {
                playerData ? (
                    <div>
